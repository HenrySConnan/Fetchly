-- Admin Dashboard Integration (SIMPLE VERSION)
-- This script creates only the essential tables needed for the admin dashboard
...
-- =============================================
-- 2. CREATE BOOKINGS TABLE (SIMPLE VERSION)
-- =============================================
CREATE TABLE IF NOT EXISTS bookings (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
  business_name TEXT, -- Store business name directly instead of foreign key
  service_name TEXT,
...
-- =============================================
-- 3. CREATE SERVICES TABLE (SIMPLE VERSION)
-- =============================================
...
-- =============================================
-- 4. CREATE PROMOTIONS TABLE (SIMPLE VERSION)
-- =============================================
...
-- =============================================
-- 5. CREATE ADMIN ANALYTICS VIEW (SIMPLE VERSION)
-- =============================================
...
-- =============================================
-- 6. CREATE BUSINESS APPROVAL FUNCTIONS
-- =============================================
